    ...
    <section className="container p-5 mx-auto">
      <div className="border border-ruddy-pink w-full min-h-[400px] rounded-lg h-full flex p-8">
        ...
        <div className="relative w-full px-3 pb-3 flex-column">
          <div className="flex">
            <div className="w-full p-3 align-middle rounded-lg bg-ruddy-pink">
            ...
            {isOwner && (
              <div className="pl-3 basis-1/4 ">
                <button
                  ...
                  className="inline-block w-full h-full m-auto text-lg leading-none text-white border rounded-lg bg-ruddy-pink hover:border-ruddy-pink hover:text-ruddy-pink hover:bg-white"
                >
                  UNDI
                </button>
              </div>
